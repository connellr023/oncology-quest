...
```json
{
  "lastUpdated": "2022-03-14T09:26:53.123456Z",
  "entries": [
    {
      "title": "TTD",
      "tasks": [
        {
          "title": "Assessing and Managing a Patient in the Outpatient Clinic",
          "tasks": [
            "NP Adjuvant",
            "NP Neoadjuvant",
            "NP Metastatic",
    ...
    },
    {
      ...
      "tasks": [
        {
          "title": "Providing an Assessment and Basic Management Plan for Patients Seen in Consultation",
          "tasks": [
        ...
        {
          "title": "Providing Assessment and Basic Management for Ongoing Care",
          "tasks": [
        ...
        {
          "title": "Prescribing Systemic Therapy (Basic Contexts)",
          "tasks": [
            "Tamoxifen",
            "AI",
            "OFS",
        ...
        {
          "title": "Assessing and Managing Urgent or Emergent Oncology Scenarios",
          "tasks": [
        ...
        {
          "title": "Coordinating Patient Care to Access Health Services",
          "tasks": [
    ...
    },
    {
      ...
      "tasks": [
        {
          "title": "Assessing New Patients Seen in Consultation and Planning Management",
          "tasks": [
            "RT for DCIS Post BCS",
            "RT for Invasive BC Post BCS Node Negative",
            "RT for Invasive BC Post BCS Node Positive",
        ...
        {
          "title": "Providing Comprehensive Assessment and Management for Ongoing Care",
          "tasks": [
            "RT for Resected DCIS or Invasive BC",
            "RT for Palliative Indication MBC",
            "OncotypeDX Results",
        ...
        {
          "title": "Prescribing Systemic Therapy",
          "tasks": [
            "Tamoxifen",
            "AI",
            "OFS",
        ...
        {
          "title": "Transitioning Away from Cancer Center FU +/- Active Anti-Cancer Therapy",
          "tasks": [
        ...
        {
          "title": "Providing Longitudinal Outpatient Care to Patients",
          "tasks": [
        ...
        {
          "title": "Working with Other Physicians and Healthcare Providers to Provide Multidisciplinary Care",
          "tasks": [
    ...
    },
    {
      ...
      "tasks": [
        {
          "title": "Managing an Outpatient Practice (With Staff Oversight/Back-up)",
          "tasks": [
